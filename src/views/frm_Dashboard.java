...
public class frm_Dashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbl_tenNhanVien.setFont(new java.awt.Font("Segoe UI Light", 1, 16)); // NOI18N
        lbl_tenNhanVien.setForeground(new java.awt.Color(51, 204, 255));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/App store 2.1.png"))); // NOI18N
        jLabel2.setText("PhoneStore");
        jPanel4.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 370, 150));
    ...
    private void btndangxuatMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btndangxuatMousePressed
        int x = JOptionPane.showConfirmDialog(this, "Bạn có muốn đăng xuất không ", "đăng xuất", JOptionPane.YES_NO_OPTION);
        if (x == 1) {
            return;
        }
